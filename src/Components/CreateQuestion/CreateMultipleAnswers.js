...
export default class CreateMultipleAnswers extends React.Component {
  constructor(){
    super();
  ...
  collector(e){
    ...
    if(text === "on"){
      ...
      const currState = this.state.answers[buttonID].correctness;
      this.state.answers[buttonID].correctness = currState === true ? false : true;
    } else {
